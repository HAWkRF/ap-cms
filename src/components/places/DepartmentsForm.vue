<template>
  <b-form
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group
            :label="$t('places.departments.labels.title')"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group
            :label="$t('places.departments.labels.address')"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group
            :label="$t('places.departments.labels.description')"
    ...
    <b-form-row>
      <b-col md="6">
        <b-form-group
            :label="$t('places.departments.labels.status')"
