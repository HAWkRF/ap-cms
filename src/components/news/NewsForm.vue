<template>
  ...
  >
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.title')" label-for="titleInput">
          <b-form-input
            id="titleInput"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.categoryIds')">
          <multiselect
          ...
          <b-form-invalid-feedback
            :style="{ display: !!form.errors.get('categoryIds') ? 'block' : 'none' }"
            v-text="form.errors.get('categoryIds')"
          ></b-form-invalid-feedback>
        </b-form-group>
      </b-col>
    </b-form-row>
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.prev_img')">
          <b-form-file
            v-model="setImg"
            :state="true"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.img')">
          <b-form-file
            v-model="setImg"
            :state="true"
            :placeholder="$t('main.load_img')"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.snippet')">
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('news.labels.content')">
    ...
    <div v-if="isSeoFieldsShown">
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('news.labels.seo_title')" label-for="seoTitleInput">
            <b-form-input
              id="seoTitleInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('news.labels.seo_description')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('news.labels.seo_keywords')"
          ...
          >
            ...
            <b-form-invalid-feedback
              :style="{ display: !!form.errors.get('seo_keywords') ? 'block' : 'none' }"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('news.labels.og_site_name')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('news.labels.og_title')" label-for="ogTitleInput">
            <b-form-input
              id="ogTitleInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('news.labels.og_type')" label-for="ogTypeInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('news.labels.og_image')" label-for="ogImageInput">
            <b-form-file
              :state="true"
              v-model="setImg"
              :placeholder="$t('main.load_img')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('news.labels.og_url')" label-for="ogUrlInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('news.labels.og_description')"
    ...
    <b-form-row>
      <b-col md="6">
        <b-form-group :label="$t('news.labels.status')" label-for="statusInput">
          <multiselect
            id="statusInput"
  ...
  watch: {
    ...
    categoryIdSelect(value) {
      if (value !== undefined) {
        ...
        this.form.categoryIds.push(value.id);
      }
    },
  },
  data: function () {
