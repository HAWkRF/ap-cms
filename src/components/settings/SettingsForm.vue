<template>
  ...
  >
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('settingsSite.labels.title')" label-for="titleInput">
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('settingsSite.labels.alias')" label-for="aliasInput">
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('settingsSite.labels.group')" label-for="groupInput">
          <b-form-input :state="form.isValid('group')" v-model="form.group">
          </b-form-input>
          <b-form-invalid-feedback
            :style="{ display: !!form.errors.get('group') ? 'block' : 'none' }"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('settingsSite.labels.type')" label-for="typeInput">
          <multiselect
            v-model="typeSelect"
            track-by="id"
            label="title"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group label-for="dataInput">
            ...
            <b-form-invalid-feedback
              :style="{ display: !!form.errors.get('data') ? 'block' : 'none' }"
              v-text="form.errors.get('data')"
            ></b-form-invalid-feedback>
          </b-form-group>
        </b-col>
