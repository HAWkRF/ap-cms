<template>
    <b-form
        ...
        <b-form-row>
            <b-col md="2">
                <b-form-group
                        :label="$t('users.profile.avatar')"
                        label-for="avatar">
                    <upload-image class="avatar-upload"
                                  ref="avatarInput"
                                  :image="form.avatar"
                                  :imageUrl="avatarUrl"
        ...
        <b-form-row>
            <b-col md="4">
                <b-form-group
                    ...
                    <b-form-invalid-feedback v-text="form.errors.get('birthdayFormatted')"></b-form-invalid-feedback>
                </b-form-group>
            </b-col>
            <b-col md="4">
                <b-form-group
                        :label="$t('users.profile.sex')"
                        label-for="sexInput">
                    <multiselect
                            id="sexInput"
                            v-model="sexIdSelect"
                    ...
                    <b-form-invalid-feedback v-text="form.errors.get('sex')"></b-form-invalid-feedback>
                </b-form-group>
            </b-col>
        </b-form-row>
