<template>
  ...
  >
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('pages.labels.title')" label-for="titleInput">
          <b-form-input
            id="titleInput"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('pages.labels.prev_img')">
          <b-form-file
            v-model="setImg"
            :state="true"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('pages.labels.content')">
    ...
    <div class="btn btn-seo btn-link mb-3" @click="isSeoFieldsShown = !isSeoFieldsShown">
      Дополнительные поля для SEO
    </div>
    <div v-if="isSeoFieldsShown">
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('pages.labels.seo_title')" label-for="seoTitleInput">
            <b-form-input
              id="seoTitleInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('pages.labels.seo_description')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('pages.labels.seo_keywords')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('pages.labels.og_site_name')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('pages.labels.og_title')" label-for="ogTitleInput">
            <b-form-input
              id="ogTitleInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('pages.labels.og_type')" label-for="ogTypeInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('pages.labels.og_image')" label-for="ogImageInput">
            <b-form-file
              :state="true"
              v-model="setImg"
              :placeholder="$t('main.load_img')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('pages.labels.og_url')" label-for="ogUrlInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('pages.labels.og_description')"
    ...
    <b-form-row>
      <b-col md="6">
        <b-form-group :label="$t('pages.labels.status')" label-for="statusInput">
          <multiselect
            id="statusInput"
