<template>
  ...
  >
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('ourWorks.labels.title')" label-for="titleInput">
          <b-form-input
            id="titleInput"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('ourWorks.labels.alias')" label-for="aliasInput">
          <b-form-input
            id="aliasInput"
    ...
    <b-form-row>
      <b-col>
        <b-form-group :label="$t('ourWorks.labels.parent_id')" label-for="parentInput">
          <multiselect
            id="parentInput"
            v-model="parentIdSelect"
            track-by="id"
            label="title"
    ...
    <b-form-row>
      <b-col md="12">
        <b-form-group :label="$t('ourWorks.labels.prev_img')">
          <b-form-file
            v-model="setImg"
            :state="true"
    ...
    <div v-if="isSeoFieldsShown">
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('ourWorks.labels.seo_title')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('ourWorks.labels.seo_description')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('ourWorks.labels.seo_keywords')"
            label-for="seoKeywordsInput"
          >
            <b-form-input
              id="seoKeywordsInput"
            ...
            <b-form-invalid-feedback
              :style="{
                display: !!form.errors.get('seo_keywords') ? 'block' : 'none',
              }"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('ourWorks.labels.og_site_name')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('ourWorks.labels.og_title')" label-for="ogTitleInput">
            <b-form-input
              id="ogTitleInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('ourWorks.labels.og_type')" label-for="ogTypeInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('ourWorks.labels.og_image')" label-for="ogImageInput">
            <b-form-file
              :state="true"
              v-model="setImg"
              :placeholder="$t('main.load_img')"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group :label="$t('ourWorks.labels.og_url')" label-for="ogUrlInput">
            <b-form-input
              id="ogTypeInput"
      ...
      <b-form-row>
        <b-col md="12">
          <b-form-group
            :label="$t('ourWorks.labels.og_description')"
    ...
    <b-form-row>
      <b-col>
        <b-form-group :label="$t('ourWorks.labels.status')" label-for="statusInput">
          <multiselect
            id="statusInput"
...
export default {
  ...
  methods: {
    ...
    async load(id) {
      ...
      this.parentIdSelect = this.categories.find((x) => x.id == this.form.parent_id);
    },
    async loadFilters() {
      const response = await Api.getFilters();
      this.statuses = response.data.statuses;
      this.categories = response.data.categories.filter((el) => el.id != this.internalId)
    },
    async submit() {
      try {
        if (this.form.id) {
