<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <div class="container-fluid">
    <div class="row-ap">
      <div class="col-12">
        <h1>{{ $t("settingsSite.page_title") }}</h1>
        <div class="search-form">
          <b-row>
            <b-col order-lg="2" lg="auto">
              <b-button
                @click="openCreateModal"
                v-text="$t('settingsSite.create')"
                block
              >
              </b-button>
            </b-col>
...
export default {
    ...
    return {
      ...
      tableOptions: {
        ...
        headings: {
          ...
          group: this.$t("settingsSite.table.group"),
          type: this.$t("settingsSite.table.type"),
          actions: "",
        },
        sortable: ["id", "title", "type", "group"],
        columnsClasses: {
          id: "id",
          actions: "actions",
          img: "img",
  ...
  computed: {
    tableColumns() {
      ...
      return ["id", "title", "group", "type", ...actions];
    },
  },
  methods: {
    searchRefresh() {
