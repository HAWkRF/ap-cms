...
export default {
  ...
  data() {
    return {
      ...
      tableOptions: {
        perPage: 10,
        headings: {
          id: this.$t("menu.table.id"),
          title: this.$t("menu.table.title"),
          alias: this.$t("menu.table.alias"),
          status_title: this.$t("menu.table.status"),
          actions: "",
        },
        sortable: ["id", "title", "alias", "status_title"],
        params: {},
      },
      formModal: {
        id: null,
  ...
  computed: {
    tableColumns() {
      ...
      return ["id", "title", "alias", "status_title", ...actions];
    },
  },
  methods: {
    imgUrl(rowItem) {
