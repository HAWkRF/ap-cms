      ...
      <div class="auth-box">
        <b-form
          ...
          <b-form-group>
            ...
            <b-form-invalid-feedback v-text="form.errors.get('code')"></b-form-invalid-feedback>
          </b-form-group>
          ...
          <b-form-group>
            ...
            <b-form-invalid-feedback v-text="form.errors.get('passwordRepeat')"></b-form-invalid-feedback>
          </b-form-group>
